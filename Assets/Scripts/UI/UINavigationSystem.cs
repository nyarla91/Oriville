...
namespace UI
{
    ...
    public class UINavigationSystem : Transformable
    {
        ...
        private void Awake()
        {
            InputDeviceWatcher.OnUISchemeChanged += UpdateSelection;
            InputDeviceWatcher.OnUISchemeSet += MouseDeselect;
        }
        ...
        {
            if (InputDeviceWatcher.CurrentUIScheme == UIScheme.Pointer || targetTransform == null)
            {
